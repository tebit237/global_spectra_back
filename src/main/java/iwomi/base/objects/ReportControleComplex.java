...
@Entity
@Table(name = "rpctrcx")
public class ReportControleComplex {
    ...
    public ReportControleComplex(Long id, String etab, String desc, String cg, String sign, String cd, String crdt,
    ...
    public ReportControleComplex() {
        super();
    }

    public Boolean setByColumn1(ReportControleComplex d) {
        if (d.cd != null) {
            this.cd = d.cd;
        }
        if (d.cg != null) {
