 ...
 * @author fabri
 */
@Entity(name = "liveTrait")
@Table(name = "liveTrait")
public class LiveTraitement{
   // @Id
   // @GeneratedValue    
   // private Long id;
    @Id
  ...
  //  Long   idope;
    ...
    public LiveTraitement(String codeLigne, String codeUnique, String codefichier, String nbtotal, String nbtraite, String statut, String details, Date dateDebut, Date dateFin) {
