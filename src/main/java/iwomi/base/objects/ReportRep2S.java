...
public class ReportRep2S implements Serializable {
	...
	public ReportRep2S(Long id, Long rang, String sens, String filter, String field, String feild, Date dar, Date vald,
	...
	public Boolean setByColumn1(ReportRep2S d) {
		int r = 0;
		if (this.valm != null) {
			this.valm = d.valm;
			r++;
	...
	public Boolean setByColumn11(ReportRep2S d) {
