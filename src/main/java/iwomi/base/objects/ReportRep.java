...
@Entity
@Table(name = "rprep")
public class ReportRep  implements Comparable< ReportRep > {
	@Id
	...
	//        if ( !(other instanceof ReportRep) ) return false;
	//
	//        final ReportRep reportRep = (ReportRep) other;
	//
	//        if ( !reportRep.getId().equals( getId() ) ) return false;
	//        if ( !reportRep.getDar().equals( getDar() ) ) return false;
	//        if ( !reportRep.getPost().equals( getPost() ) ) return false;
	//        if ( !reportRep.getFichier().equals( getFichier() ) ) return false;
	//        if ( !reportRep.getEtab().equals( getEtab() ) ) return false;
	//        if ( !reportRep.getCol().equals( getCol() ) ) return false;
	//
	//        return true;
	//    }
	//	
	//	 public int hashCode() {
	//	        int result;
	//	        result = getFichier().hashCode();
	//	        result = (int) (29 * result + getRang()+Integer.parseInt(getCol()));
	//	        return result;
	//	    }
	//	
	//	@Id
	...
	public ReportRep(Long id, Long rang, String sens, String filter, String field, String feild, Date dar, Date vald,
	...
	public Boolean setByColumn1(ReportRep d) {
		int r = 0;
		if (this.valm != null) {
			this.valm = d.valm;
			r++;
	...
	public Boolean setByColumn11(ReportRep d) {
	...
	@Override
	public int compareTo(ReportRep arg0) {
