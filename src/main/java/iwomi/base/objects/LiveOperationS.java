...
//    }
    ...
    public LiveOperationS(String cetab, String codeUnique, String operations, String usid, Long statut, Long nbtotal, Long nbtraite, String details, Date dateDebut, Date dateEnd) {
        this.cetab = cetab;
        this.codeUnique = codeUnique;
        this.operations = operations;
        this.usid = usid;
