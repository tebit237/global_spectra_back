...
public class ReportResultFom {
    ...
    public ReportResultFom(String success, String codeFic, String statutFic, String valueFic, String statutOp, String valueOp) {
        this.success = success;
        this.codeFic = codeFic;
        this.statutFic = statutFic;
        this.valueFic = valueFic;
     ...
     public ReportResultFom(){
      
      }

	public ReportResultFom(String success, String codeFic, String statutFic, String valueFic, String statutOp,
