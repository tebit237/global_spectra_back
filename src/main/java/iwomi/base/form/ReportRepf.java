...
public class ReportRepf implements Comparable< ReportRepf> {
    ...
    public ReportRepf(Long id, Long rang, String sens, String filter, String field, String feild, Date dar, Date vald,
    ...
    public Boolean setByColumn1(ReportRepf d) {
        int r = 0;
        if (this.valm != null) {
            this.valm = d.valm;
            r++;
    ...
    public Boolean setByColumn11(ReportRepf d) {
    ...
    @Override
    public int compareTo(ReportRepf arg0) {
