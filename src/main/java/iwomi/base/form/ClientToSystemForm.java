 ...
 * @author fabri
 */
public class ClientToSystemForm {
    ...
    public ClientToSystemForm(String  date, String periodicity, String cetab, String usid, String codeUnique, String operation, String type, List<CodeForm> codeInventaires) {
        this.date = date;
        this.periodicity = periodicity;
        this.cetab = cetab;
        this.usid = usid;
